...
class App(Frame):
    ...
    def init_gui(self,)-> None:
        ...
        self.parent.title('Temperatura del SENSOR XD')
        ...
        self.bg_image = PhotoImage(file="miles_alreves_xd.png", width=500, height=200)  # Guardar referencia a la imagen
        ...
        # Cargar y mostrar la imagen de fondo
        self.bg_image2 = PhotoImage(file="miles.png", width=500, height=200)  # Guardar referencia a la imagen
    ...
    def _create_creators_names_label(self) -> Label:
        return Label(
            master = self,
            #text = 'Hector, Eduardo y Mario',
            #text2 = 'Hector, Eduardo y Mario',
            #background='red',
            #foreground = 'black',
